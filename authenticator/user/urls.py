from .views import user_login,Get_Data,Serialized_data_view,Register,Login,Post_supply_chain_data,Supply_Api_view,Firm_table_data,Firm_data_api_view,Post_product_config_data,Product_config_api_view,post_procurement_data,procurement_api_view
