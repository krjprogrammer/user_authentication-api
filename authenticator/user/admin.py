...
class manufacturing_admin(admin.ModelAdmin):
    list_display = ('admin_ID', 'user_id', 'simulation_id', 'production_product_0_units', 'production_hyperware_units', 'production_metaware_units', 'product_0_info', 'product_hyperware_info', 'product_metaware_info')
admin.site.register(manufacturing_decision_table,manufacturing_admin)
