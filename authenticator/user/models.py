...
class manufacturing_decision_table(models.Model):
    admin_ID = models.IntegerField()
    user_id = models.IntegerField()
    simulation_id = models.IntegerField()
    production_product_0_units = models.IntegerField(null=True)
    production_hyperware_units = models.IntegerField(null=True)
    production_metaware_units = models.IntegerField(null=True)
